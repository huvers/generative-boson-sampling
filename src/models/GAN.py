...
class GAN():
    def __init__(self
        ...
        self.discriminator_dense_layers = discriminator_dense_layers
        self.discriminator_batch_norm_momentum = discriminator_batch_norm_momentum
        self.discriminator_activation = discriminator_activation
        self.discriminator_dropout_rate = discriminator_dropout_rate
        self.discriminator_learning_rate = discriminator_learning_rate

        self.generator_dense_layers = generator_dense_layers
        ...
        self.n_layers_discriminator = len(discriminator_dense_layers)
        self.n_layers_generator = len(generator_dense_layers)
    ...
    def _build_discriminator(self):
        ...
        for i in range(self.n_layers_discriminator):
            dense_layer = Dense(self.discriminator_dense_layers[i]
                , name = 'discriminator_dense_' + str(i)
                )
    ...
    def _build_generator(self):
        ...
        for i in range(self.n_layers_generator):
            dense_g_layer = Dense(
                self.generator_dense_layers[i]
                , name = 'dense_g_layer_' + str(i)
                )
            x = dense_g_layer(x)
